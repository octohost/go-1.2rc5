...
# install go
RUN curl -sf -o /tmp/downloads/go1.2rc5.linux-amd64.tar.gz -L https://go.googlecode.com/files/go1.2rc5.linux-amd64.tar.gz
RUN mkdir -p /opt && cd /opt && tar xfz /tmp/downloads/go1.2rc5.linux-amd64.tar.gz
